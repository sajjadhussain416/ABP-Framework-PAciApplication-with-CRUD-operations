...
{
    /// <inheritdoc />
    public partial class CreatedpaciiApp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PaciApplications",
                columns: table => new
                {
                    PaciApplicationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationGuidId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApplicationName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApplicationDescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApplicationDescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Challange = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaciApplications", x => x.PaciApplicationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaciAuditLogId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaciAuditLogs", x => x.PaciAuditLogId);
                });

            migrationBuilder.CreateTable(
                name: "PaciAuthReceiveRequests",
                columns: table => new
                {
                    PaciAuthenticationRecieveRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CivilId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    NationalityAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    AllJsonData = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    FlexField = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BirthDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BloodGroup = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DocumentNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GovData = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaciAuthReceiveRequests", x => x.PaciAuthenticationRecieveRequestId);
                });

            migrationBuilder.CreateTable(
                name: "PaciAuthSendRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaciAuthSendRequestId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    IsUserDetails = table.Column<bool>(type: "bit", nullable: false),
                    AssuranceLevel = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaciAuthSendRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaciSettingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    FlexColumn1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FlexColumn2 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaciSettings", x => x.PaciSettingId);
                });
